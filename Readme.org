...
Heavily customized Emacs are sometimes said slow to start-up, and
ad-hoc techniques like =emacsclient= are used as workarounds. But,
remember, vanilla Emacs, more than 1000 elisps built-in, does not take
so long time to launch. Doesn't it seem possible to write faster init
script?
